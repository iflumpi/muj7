...
$(DEBUGGER_TARGET): $(DEBUGGER_SOURCE) $(MUJ7_HELPER_SOURCE) $(LIBMUJ7_TARGET) 
	$(CC) $(DEBUGGER_SOURCE) $(MUJ7_HELPER_SOURCE) -L$(BUILD_FOLDER) -lmuj7 -lncurses $(CC_FLAGS) -o $(DEBUGGER_TARGET)

machine: $(MACHINE_TARGET)

$(MACHINE_TARGET): $(MACHINE_SOURCE) $(LIBMUJ7_TARGET)
	$(CC) $< $(MUJ7_HELPER_SOURCE) -I$(SRC_FOLDER) -o $@ -L$(BUILD_FOLDER) -lmuj7 -lSDL2 -lm
